...
const MemberDepartmentProgressPage = () => {
  ...
  const exportExcel = () => {
    ...
    member.departmentProgress(did, page, total, filter).then((res: any) => {
      ...
      let filename = title + "Study Progress.xlsx";
  ...
  return (
    <div className="playedu-main-body">
      <div className="float-left mb-24">
        <BackBartment title={title + "Study Progress"} />
      </div>
      <div className="float-left j-b-flex mb-24">
        <div className="d-flex">
          ...
          (The numbers in the following table correspond to the "Number of classes completed/total number of classes" in the header class)
          </div>
        </div>
        <div className="d-flex">
