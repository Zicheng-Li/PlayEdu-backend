...
const ResourceCategoryPage = () => {
          ...
          title: (
            <>
              ...
              <div className="d-flex">
                <Tooltip placement="top" title="Draggable Sorting">
                  <i
            ...
            content: (
              <p>
                ...
                <span className="c-red">
                  ({res.data.children.length}Subcategories)
                </span>
            ...
            content: (
              <p>
                ...
                {res.data.videos.length > 0 && (
                  ...
                  >
                    （{res.data.videos.length}Video files）,
                  </Button>
                )}
                {res.data.images.length > 0 && (
                  <Button
                  ...
                  >
                    （{res.data.images.length}Image files）,
                  </Button>
                )}
                Please unlink before deleting!
              </p>
  ...
  const delUser = (id: any) => {
    confirm({
      ...
      content: "Confirm to delete this category？",
      centered: true,
      okText: "Confirmed",
      cancelText: "Cancel",
      onOk() {
